...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'ayaniyan88@gmail.com',
            'smtp_pass' => 'Belum222',
            'smtp_port' =>  465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
        ...
        $this->email->from('ayaniyan88@gmail.com', 'Admin Desa Sumuranja');
    ...
    public function resetPassword()
    {
        ...
        if ($user) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Reset password gagal, Emailnya salah</div>');
            redirect('auth');
        }
    }
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Password berhasil diubah!! Silahkan masuk</div>');
            redirect('auth');
        }
    }
}

                ...
                <tbody>
                    ...
                    <?php foreach ($alamat as $ala) : ?>
                        <tr>
                            ...
                            <td><?= $ala['alamat']; ?></td>
                            <td>
                                <a href="<?= base_url('profile/editinfo/') . $ala['id']; ?>" class="badge badge-pill badge-primary"> <i class="fas fa-edit"></i>Edit</a>
                                <a href="<?= base_url('profile/deleteinfo/') . $ala['id']; ?>" class="badge badge-pill badge-danger" onclick="return confirm('Really?');"> <i class="fas fa-trash"></i>Hapus</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
...
<div class="modal fade" id="NewdataModal" tabindex="-1" role="dialog" aria-labelledby="NewdataModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('profile/info'); ?>" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Nama Alamat">
                    </div>
                </div>
